...
table.append(["Ejecución " + str(i + 1) for i in range(num_executions)])  # Filas para las ejecuciones
...
test_data = [random.randint(0, max_value) for _ in range(max(data_sizes))]  # Generar datos de prueba una vez
